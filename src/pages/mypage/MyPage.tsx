...
export function MyPage() {
  ...
  const [exerciseCount, setExerciseCount] =
    useState<ExerciseCount>('NONE')

  const [exerciseIntensity, setExerciseIntensity] =
    useState<ExerciseIntensity>('LOW')
  ...
  const [inbodyHistory, setInbodyHistory] =
    useState<InbodyHistoryItem[]>([])
